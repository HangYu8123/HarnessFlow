...
3. The main agent validates the final diff against [final plan] and [implementation report]. Checklist: target functionalities achieved, no regressions, existing tests/behavior preserved.
