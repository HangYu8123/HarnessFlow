...
description: 'Token-effective Codex instructions for executing commands and skills: main-agent plan, one parallel challenge + research subagent step, and direct execution with captured-output validation — with Codex agent workers and sequential fallback'
---
