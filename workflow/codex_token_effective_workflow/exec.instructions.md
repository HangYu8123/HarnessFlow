---
name: 'Token-Effective Cmd/Skill Execution (Codex)'
description: 'Token-effective Codex instructions for executing commands and skills with Codex agent workers, Codex-in-VS-Code compatibility, and sequential fallback'
---
