...
description: 'Token-effective Codex instructions for breaking down and creating pull requests with Codex agent workers, Codex-in-VS-Code compatibility, and sequential fallback'
---
