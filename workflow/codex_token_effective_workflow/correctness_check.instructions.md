...
description: 'Token-effective Codex instructions for verifying repo correctness with Codex agent workers, Codex-in-VS-Code compatibility, and sequential fallback'
---
