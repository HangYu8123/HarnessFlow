...
description: 'Token-effective Codex instructions for answering repo questions: main-agent answer drafting with one parallel challenge + research subagent step. Read-only — with Codex agent workers and sequential fallback'
---
