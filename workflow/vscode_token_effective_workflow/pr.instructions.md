...
description: 'Streamlined breakdown and creation of pull requests from feature branches: main-agent diff analysis with file-completeness verification, one parallel challenge + research subagent step, and direct stack execution using the breakdown-pr skill'
---
