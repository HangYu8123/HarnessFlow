...
4. **Validate — adversarial + research.** The main agent creates two subagents and **[PARALLEL EXECUTION — launch all listed subagents in parallel; see [`/Users/hangyu/UMI_2026/agentic_training_loop/.github/HarnessFlow/_lib/workflow_contract.md`](../../_lib/workflow_contract.md) §Parallel Execution & Fallback]**, passing the repo context (per §Context Passing) + [consolidated loop spec] + [iteration plan]:
