...
- Use pack-relative filesystem paths resolved via Pack Path Resolution (`.github/harness_coding_instructions/<path>` in installed repos, or `<path>` from repo root in the source repo)
