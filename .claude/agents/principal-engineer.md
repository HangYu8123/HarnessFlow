...
description: "HarnessFlow worker subagent — spawn only from a HarnessFlow workflow step, never by autonomous delegation. Reviews all plans and comparison statements from a principal engineer perspective — assesses correctness, feasibility, and rejects redundant proposals."
tools: Read, Grep, Glob
model: inherit
maxTurns: 60
---

<!-- Generated by HarnessFlow sync_agent_definitions.py from agents/principal-engineer.agent.md — do not edit by hand. -->
