...
description: "HarnessFlow worker subagent — spawn only from a HarnessFlow workflow step, never by autonomous delegation. Identifies robustness issues, potential bugs, and proposes improvements to make the codebase more resilient."
tools: Read, Grep, Glob
model: inherit
---

<!-- Generated by HarnessFlow sync_agent_definitions.py from agents/robustness-analyst.agent.md — do not edit by hand. -->
