...
description: "HarnessFlow worker subagent — spawn only from a HarnessFlow workflow step, never by autonomous delegation. Critically challenges plans and analyses — looks for overlooked side effects, integration risks, incorrect assumptions, or potential regressions."
tools: Read, Grep, Glob
model: inherit
maxTurns: 60
---

<!-- Generated by HarnessFlow sync_agent_definitions.py from agents/devils-advocate.agent.md — do not edit by hand. -->
