...
description: "HarnessFlow worker subagent — spawn only from a HarnessFlow workflow step, never by autonomous delegation. Reviews plans and code from a senior staff engineer perspective — assesses correctness, feasibility, and potential regressions."
tools: Read, Grep, Glob
model: inherit
---

<!-- Generated by HarnessFlow sync_agent_definitions.py from agents/senior-engineer.agent.md — do not edit by hand. -->
